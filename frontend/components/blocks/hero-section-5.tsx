                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">Premium Barbershop Experience</h1>
                                <p className="mt-8 max-w-2xl text-balance text-lg">Experience world-class barbering with a futuristic touch. Where traditional craftsmanship meets next-generation aesthetic precision.</p>
